...
integer, parameter :: iteration_max=100,iteration_min=200000,interval=100
...
integer*4:: startday(3), starttime ,endday(3), endtime !Real time
...
!Do WHILE ((iteration1<iteration_min))
    starttime =  omp_get_wtime()  ! starttime(1)=hour, (2)=minute, (3)=second
...
!   Print out results
!***********************************************************************
    endtime = omp_get_wtime()     ! endtime(1)=hour, (2)=minute, (3)=second
    wall_time = endtime-starttime
